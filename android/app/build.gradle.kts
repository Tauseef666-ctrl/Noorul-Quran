...
android {
    namespace = "com.noorulquran.app"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.noorulquran.app"
        // Overridden at CI time from the git tag (see .github/workflows/build-apk.yml).
        // Placeholder values keep local/IDE builds working.
        minSdk = 24
        targetSdk = 36
        versionCode = 10000
        versionName = "1.0.0"
